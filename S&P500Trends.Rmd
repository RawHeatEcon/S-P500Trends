...
A = data.frame(date=as.Date(c("2014-08-25", "2015-06-23", "2017-06-16")), event=c("Aug 2014", "Jun 2015", "Jun 2017"))

# Creating a data frame to aid in labeling key dates

Amazon <- ggplot(SP_data %>% filter(Name %in% c("AMZN")), aes(x = Date, y = close)) + geom_point(alpha = (1/6), size = 2) + geom_smooth(lwd = 1, se = TRUE) + labs(title = "Amazon", subtitle = "2013 to 2018", y = "Date", x = "Closing price (USD)") + geom_v
...
summer <- data.frame(Name = c("NEE","CVX","EOG","XOM","COP"), Date = c("2017-04-28", "2017-04-28", "2017-04-28", "2017-04-28", "2017-04-28"), mean_close = c("133.56","106.70","92.50","81.65","47.91"), stringsAsFactors=FALSE)

spring <- data.frame(Name = c("NEE","CVX","EOG","XOM","COP"), Date = c("2017-08-31", "2017-08-31", "2017-08-31", "2017-08-31", "2017-08-31"), mean_close = c("150.51","107.62","84.99","76.33","43.66"), stringsAsFactors=FALSE) 
